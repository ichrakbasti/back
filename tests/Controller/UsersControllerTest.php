...
class UsersControllerTest extends WebTestCase
{
    ...
    public function testShow(): void
    {
        ...
        $fixture->setGorgiasUserId('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setGorgiasUserId('Value');
        ...
        $this->client->submitForm('Update', [
            ...
            'user[gorgiasUserId]' => 'Something New',
        ...
        self::assertSame('Something New', $fixture[0]->getGorgiasUserId());
